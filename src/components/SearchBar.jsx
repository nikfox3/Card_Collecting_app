  ...
  return (
    <div className={`flex items-center gap-2 mb-3 px-4 py-0 relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] ${isModalOpen ? 'z-0' : (isMenuOpen ? 'z-0' : 'z-auto')} ${className}`}>
      <div className="flex items-center min-h-0 min-w-0 pl-0 pr-7 py-0 relative shrink-0 w-full">
        ...
        <div className={`bg-[#2b2b2b] flex gap-2.5 grow h-[48px] items-center min-h-0 min-w-0 ${showScanButton ? 'mr-[-28px] pl-10' : 'mr-0 pl-4'} pr-3 py-4 relative rounded rounded-[4px] shrink-0 ${isModalOpen ? 'z-0' : (isMenuOpen ? 'z-0' : 'z-[1]')} border border-[#383838]`}>
          {/* Search Icon */}
